...
public class XmlWriters {
    ...
    public XmlWriters element(String parentName, Object... childPairs){
        if (childPairs.length % 2 != 0){
            throw new IllegalArgumentException("var args's length must % 2 = 0");
        }
        E parent = new TextE(parentName, null);
        parent.children = getChildren(childPairs);
        es.add(parent);
        return this;
    }
    ...
    private List<E> getChildren(Object... childPairs) {
