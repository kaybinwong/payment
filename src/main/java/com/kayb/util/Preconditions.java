...
public class Preconditions {
    ...
    /**
     * Ensures the false of an expression involving one or more parameters to the calling method.
     *
     * @param expression   a boolean expression
     * @param errorMessage the exception message to use if the check fails; will be converted to a
     *                     string using {@link String#valueOf(Object)}
     * @throws IllegalArgumentException if {@code expression} is false
     */
    public static void assertFalse(boolean expression, Object errorMessage) {
        if(expression == true) {
            throw new IllegalArgumentException(String.valueOf(errorMessage));
        }
    }
   ...
   */
    ...
    public static int assertElementIndex(int index, int size) {
        return assertElementIndex(index, size, "index");
    }
     ...
     * @throws IllegalArgumentException  if {@code size} is negative
     */
    public static int assertElementIndex(int index, int size, String desc) {
    ...
    public static void assertNotNullAndEmpty(Collection<?> checking, String field){
        if (checking == null || checking.isEmpty()){
            throw new IllegalArgumentException(field + CAN_NOT_NULL_EMPTY);
        }
    }

    public static void assertPositive(Integer number, String field){
        if (number == null || number.intValue() < 0){
            throw new IllegalArgumentException(field + MUST_GT_0);
        }
    }

    public static void assertNegative(Integer number, String field){
        if (number == null || number.intValue() > 0){
            throw new IllegalArgumentException(field + MUST_LT_0);
        }
    }

    public static void assertPositive(Long number, String field){
        if (number == null || number.longValue() < 0){
            throw new IllegalArgumentException(field + MUST_GT_0);
        }
    }

    public static void assertNegative(Long number, String field){
        if (number == null || number.longValue() > 0){
            throw new IllegalArgumentException(field + MUST_LT_0);
        }
    }

    public static void assertPositive(Double number, String field){
        if (number == null || number.doubleValue() < 0){
            throw new IllegalArgumentException(field + MUST_GT_0);
        }
    }

    public static void assertNegative(Double number, String field){
        if (number == null || number.doubleValue() > 0){
            throw new IllegalArgumentException(field + MUST_LT_0);
        }
    }

    public static void assertPositive(Float number, String field){
        if (number == null || number.floatValue() < 0){
            throw new IllegalArgumentException(field + MUST_GT_0);
        }
    }

    public static void assertNegative(Float number, String field){
        if (number == null || number.floatValue() > 0){
            throw new IllegalArgumentException(field + MUST_LT_0);
        }
    }

    public static void assertPositive(BigDecimal number, String field){
        if (number == null || number.compareTo(BigDecimal.ZERO) < 0){
            throw new IllegalArgumentException(field + MUST_GT_0);
        }
    }

    public static void assertNegative(BigDecimal number, String field){
        if (number == null || number.compareTo(BigDecimal.ZERO) > 0){
            throw new IllegalArgumentException(field + MUST_LT_0);
        }
    }
